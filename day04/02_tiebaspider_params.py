...
class TiebaImageSpider:
    def __init__(self):
        self.one_url = "http://tieba.baidu.com/f?"
        # 使用TE的User-Agent
        self.headers = {
    ...
    def get_html(self, params):
        html = requests.get(url=self.one_url, params=params, headers=self.headers).text
        return html
    ...
    def save_image(self, href_link):
        two_html = requests.get(url=href_link, headers=self.headers).text
